...
class VisualizzaAbbonamentiAttivi(object):
    ...
    def retranslateUi(self, Frame):
        ...
        item.setText(_translate("Frame", "Data Emissione (g/m/a):"))
        item = self.tableWidget.horizontalHeaderItem(6)
        item.setText(_translate("Frame", "Data Scadenza (g/m/a):"))
        ...
        for riga in range(0, self.leggiNumeroAbbonamentiAttivi()):
            ...
            item.setText(_translate("Frame", abbonamentoAttivo.toString().getNome()))
            item = self.tableWidget.item(riga, 1)
            item.setText(_translate("Frame", abbonamentoAttivo.toString().getCognome()))
            item = self.tableWidget.item(riga, 2)
            item.setText(_translate("Frame", abbonamentoAttivo.toString().getCodiceFiscale()))
            item = self.tableWidget.item(riga, 3)
            item.setText(_translate("Frame", abbonamentoAttivo.toString().getTelefono()))
            item = self.tableWidget.item(riga, 4)
            item.setText(_translate("Frame", abbonamentoAttivo.toString().getEmail()))
