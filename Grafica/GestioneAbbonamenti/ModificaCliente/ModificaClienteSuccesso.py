...
class ModificaClienteSuccesso(object):
    ...
    def setupUi(self, Frame):
        ...
        self.pushButtonGestioneAbbonamentiPrincipale.setObjectName("pushButton_7")
    ...
    def retranslateUi(self, Frame):
        ...
        self.label_5.setText(_translate("Frame", "Il cliente è stato modificato con successo.\n"
                                                 " Cliccare sul pulsante gestione per tornare alla gestione\n"
                                                 " degli abbonamenti."))
