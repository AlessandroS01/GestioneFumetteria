...
# Form implementation generated from reading ui file 'C:\Users\Lenovo\Downloads\AggiungiOfferta.ui'
#
...
class AggiungiOffertaDopoRicerca(object):
    ...
    def setupUi(self, Frame, prodotto):
        ...
        self.pushButton_5.setGeometry(QtCore.QRect(10, 350, 141, 31))
        font = QtGui.QFont()
        ...
        self.pushButton_4.setGeometry(QtCore.QRect(160, 350, 141, 31))
        font = QtGui.QFont()
        font.setFamily("Helvetica")
        font.setPointSize(12)
        font.setBold(True)
    ...
    def clickAggiungiOfferta(self):
        ...
        amministratore.aggiungiOffertaProdotto(self.prodottoTrovato.getCodiceSeriale(),
                                               tipoOfferta, prezzoOfferta, dataScadenzaOffertaText)
