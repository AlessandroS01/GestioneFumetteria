...
class EliminaOffertaEffettuata(object):
    ...
    def retranslateUi(self, Frame):
        ...
        Frame.setWindowTitle(_translate("Frame", "Fumetteria - Offerta Eliminata"))
        self.label_4.setText(_translate("Frame", "OFFERTA ELIMINATA"))
        self.pushButtonMagazzino.setText(_translate("Frame", "Magazzino"))
        self.label_5.setText(_translate("Frame", "L\'offerta è stata eliminata con successo.\n"
