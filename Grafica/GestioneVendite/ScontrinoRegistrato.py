...
class ScontrinoRegistrato(object):
    ...
    def setupUi(self, Frame):
        ...
        icon.addPixmap(QtGui.QPixmap("Images\\warehouse.png"),
    ...
    def retranslateUi(self, Frame):
        ...
        Frame.setWindowTitle(_translate("Frame", "Fumetteria - Scontrino Registrato"))
        self.label_4.setText(_translate("Frame", "SCONTRINO REGISTRATO"))
        self.pushButtonGestioneVenditePrincipale.setText(_translate("Frame", "Vendite"))
        self.label_5.setText(_translate("Frame", "Lo scontrino è stato registrato correttamente\n"
